...
)
{
    ...
    @RequiresApi(Build.VERSION_CODES.O)
    fun imageColor(context: Context): Int = if(isCompleted()) purpule(context) else black(context)

    private fun purpule(context: Context) = ContextCompat.getColor(context , R.color.purple_500)
